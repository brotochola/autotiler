/*!
 * @pixi/tilemap - v5.0.2
 * Compiled Mon, 14 Jul 2025 00:24:17 UTC
 *
...
class ae {
  ...
  execute({ tilemap: e }) {
    ...
    const { pipe_uniforms: t } = this.adaptor,
      i = t.uniforms.u_proj_trans,
...
class de extends se {
  ...
  execute(e, t) {
    const i = e.renderer,
      s = this._shader,
      n = t.getTileset(),
      u = s.resources.texture_uniforms;
    u.uniforms.u_texture_size !== n.tex_sizes &&
      ((u.uniforms.u_texture_size = n.tex_sizes), u.update());
    for (let l = 0; l < n.length; l++) i.texture.bind(n.arr[l], l);
    i.encoder.draw({
      geometry: t.vb,
      shader: s,
      state: t.state,
...
class oe extends Te {
    ...
    if (e instanceof F) ((this.tileset = e), (this.didViewUpdate = !0));
      ...
      if (e.length === s.count) {
        ...
        for (let u = 0; u < e.length; u++)
          if (((t = e[u]) == null ? void 0 : t.source) !== s.arr[u]) {
            n = !1;
            break;
          }
        if (n) return this;
  ...
  tile(e, t, i, s = {}) {
    ...
    const {
      ...
      p = this.pointsBuf;
    return (
      (this.hasAnimatedTile = this.hasAnimatedTile || T > 0 || m > 0),
      p.push(h),
      p.push(y),
      p.push(t),
      p.push(i),
      ...
      p.push(L),
      p.push(k),
      this.tilemapBounds.addFrame(t, i, t + P, i + x),
      this
    );
  }
  tileRotate(e) {
  ...
  updateBuffer(e) {
    ...
    let o = 0,
      g = 0;
    for (let h = 0; h < t.length; h += A) {
      this.compositeParent && (g = t[h + 9]);
      const y = t[h + 2],
        P = t[h + 3],
        x = t[h + 4],
        T = t[h + 5],
...
class Le extends Ae {
  ...
  tileset(e) {
    e || (e = []);
    const t = this.texturesPerTilemap,
      i = this.children.length,
      s = Math.ceil(e.length / t);
    for (let n = 0; n < Math.min(i, s); n++)
  ...
  isModified(e) {
    ...
    if (this.modificationMarker !== t.length) return !0;
    for (let i = 0; i < t.length; i++) if (t[i].isModified(e)) return !0;
    return !1;
  }
  clearModify() {
    const e = this.children;
    this.modificationMarker = e.length;
    for (let t = 0; t < e.length; t++) e[t].clearModify();
  }
  addFrame(e, t, i, s, n, u, l, a, f) {
    return this.tile(e, t, i, {
      animX: s,
      animY: n,
      animCountX: u,
      animCountY: l,
  ...
  addRect(e, t, i, s, n, u, l, a, f, o, g, h) {
    const y = (e / this.texturesPerTilemap) >> 0,
      P = e % this.texturesPerTilemap;
    return (
      this.children[y] && this.children[y].getTileset().count > 0
        ? ((this.lastModifiedTilemap = this.children[y]),
          this.lastModifiedTilemap.addRect(P, t, i, s, n, u, l, a, f, o, g, h))
